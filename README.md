...
| `PORT` | 服务端口 | 可选 | `3000` |
| `JWT_SECRET` | JWT 签名密钥，用于用户认证 | 可选 | your-strong-jwt-secret-at-least-32-characters |
| `ENCRYPTION_KEY` | 数据加密密钥，用于加密 API Key 等敏感信息 | 可选 | your-32-character-encryption-key |
